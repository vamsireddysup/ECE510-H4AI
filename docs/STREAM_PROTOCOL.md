# Packed stream protocol, version 1

This is the active 64-bit AXI4-Stream contract for the dense FP4 E2M1 QK^T
engine. Register `0x1C` returns version `1`. A command starts when software
...
The host sends one scale packet, then tile packets in this order:
