...
VL_INLINE_OPT void Vpe___024root___nba_sequent__TOP__0(Vpe___024root* vlSelf) {
    ...
    if (vlSelfRef.rst_n) {
        if (((IData)(vlSelfRef.pe__DOT__u_mul__DOT__s3_valid) 
             & (~ (IData)(vlSelfRef.pe__DOT__all_collected)))) {
            __VdlyVal__pe__DOT__prod_buf__v0 = vlSelfRef.pe__DOT__u_mul__DOT__s3_result;
        ...
        vlSelfRef.pe__DOT__u_mul__DOT__s3_result = 
            ((IData)(vlSelfRef.pe__DOT__u_mul__DOT__s2_is_nan)
              ? 0x7fc00000U : ((IData)(vlSelfRef.pe__DOT__u_mul__DOT__s2_is_inf)
                                ? (0x7f800000U | ((IData)(vlSelfRef.pe__DOT__u_mul__DOT__s2_sign) 
                                                  << 0x1fU))
                                : ((IData)(vlSelfRef.pe__DOT__u_mul__DOT__s2_is_zero)
                                    ? ((IData)(vlSelfRef.pe__DOT__u_mul__DOT__s2_sign) 
                                       << 0x1fU) : 
                                   ((1U & (IData)((vlSelfRef.pe__DOT__u_mul__DOT__s2_product 
                                                   >> 0x2fU)))
                                     ? (((IData)(vlSelfRef.pe__DOT__u_mul__DOT__s2_sign) 
                                         << 0x1fU) 
                                        | ((0x7f800000U 
                                            & (((IData)(1U) 
                                                + (IData)(vlSelfRef.pe__DOT__u_mul__DOT__s2_exp)) 
                                               << 0x17U)) 
                                           | (0x7fffffU 
                                              & (IData)(
                                                        (vlSelfRef.pe__DOT__u_mul__DOT__s2_product 
                                                         >> 0x18U)))))
                                     : (((IData)(vlSelfRef.pe__DOT__u_mul__DOT__s2_sign) 
                                         << 0x1fU) 
                                        | ((0x7f800000U 
        ...
        vlSelfRef.pe__DOT__u_mul__DOT__s2_exp = vlSelfRef.pe__DOT__u_mul__DOT__s1_exp;
        vlSelfRef.pe__DOT__u_mul__DOT__s2_product = 
            (0xffffffffffffULL & ((QData)((IData)(vlSelfRef.pe__DOT__u_mul__DOT__s1_sig_a)) 
                                  * (QData)((IData)(vlSelfRef.pe__DOT__u_mul__DOT__s1_sig_b))));
        vlSelfRef.pe__DOT__u_mul__DOT__s1_exp = (0x3ffU 
                                                 & (((0xffU 
                                                      & (vlSelfRef.a_in 
                                                         >> 0x17U)) 
                                                     + 
                                                     (0xffU 
                                                      & (vlSelfRef.b_in 
                                                         >> 0x17U))) 
                                                    - (IData)(0x7fU)));
        vlSelfRef.pe__DOT__u_mul__DOT__s1_sig_a = (0x800000U 
                                                   | (0x7fffffU 
                                                      & vlSelfRef.a_in));
        vlSelfRef.pe__DOT__u_mul__DOT__s1_sig_b = (0x800000U 
                                                   | (0x7fffffU 
                                                      & vlSelfRef.b_in));
    } else {
        ...
        __Vdly__pe__DOT__waiting = 0U;
        vlSelfRef.pe__DOT__u_mul__DOT__s3_result = 0U;
        vlSelfRef.pe__DOT__add_result = 0U;
        vlSelfRef.pe__DOT__u_mul__DOT__s2_exp = 0U;
        vlSelfRef.pe__DOT__u_mul__DOT__s2_product = 0ULL;
        vlSelfRef.pe__DOT__u_mul__DOT__s1_exp = 0U;
        vlSelfRef.pe__DOT__u_mul__DOT__s1_sig_a = 0U;
        vlSelfRef.pe__DOT__u_mul__DOT__s1_sig_b = 0U;
    }
    ...
    vlSelfRef.pe__DOT__u_mul__DOT__s3_valid = ((IData)(vlSelfRef.rst_n) 
                                               && (IData)(vlSelfRef.pe__DOT__u_mul__DOT__s2_valid));
    ...
    vlSelfRef.pe__DOT__u_add__DOT__zero_b = (IData)(
                                                    (0U 
                                                     ...
                                                     (0x7fffffffU 
                                                      & vlSelfRef.pe__DOT____Vcellinp__u_add__b)));
    vlSelfRef.pe__DOT__u_mul__DOT__s2_valid = ((IData)(vlSelfRef.rst_n) 
                                               && (IData)(vlSelfRef.pe__DOT__u_mul__DOT__s1_valid));
    vlSelfRef.pe__DOT__u_mul__DOT__s2_is_zero = ((IData)(vlSelfRef.rst_n) 
                                                 && (IData)(vlSelfRef.pe__DOT__u_mul__DOT__s1_is_zero));
    vlSelfRef.pe__DOT__u_mul__DOT__s2_sign = ((IData)(vlSelfRef.rst_n) 
                                              && (IData)(vlSelfRef.pe__DOT__u_mul__DOT__s1_sign));
    vlSelfRef.pe__DOT__u_mul__DOT__s2_is_inf = ((IData)(vlSelfRef.rst_n) 
                                                && (IData)(vlSelfRef.pe__DOT__u_mul__DOT__s1_is_inf));
    vlSelfRef.pe__DOT__u_mul__DOT__s2_is_nan = ((IData)(vlSelfRef.rst_n) 
                                                && (IData)(vlSelfRef.pe__DOT__u_mul__DOT__s1_is_nan));
    ...
    vlSelfRef.pe__DOT__u_mul__DOT__s1_valid = ((IData)(vlSelfRef.rst_n) 
                                               && (IData)(vlSelfRef.valid_in));
    vlSelfRef.pe__DOT__u_mul__DOT__s1_is_zero = ((IData)(vlSelfRef.rst_n) 
                                                 && ((IData)(vlSelfRef.pe__DOT__u_mul__DOT__zero_a) 
                                                     | (IData)(vlSelfRef.pe__DOT__u_mul__DOT__zero_b)));
    vlSelfRef.pe__DOT__u_mul__DOT__s1_sign = ((IData)(vlSelfRef.rst_n) 
                                              && ((vlSelfRef.a_in 
                                                   ^ vlSelfRef.b_in) 
                                                  >> 0x1fU));
    vlSelfRef.pe__DOT__u_mul__DOT__s1_is_inf = ((IData)(vlSelfRef.rst_n) 
                                                && ((((IData)(vlSelfRef.pe__DOT__u_mul__DOT__inf_a) 
                                                      | (IData)(vlSelfRef.pe__DOT__u_mul__DOT__inf_b)) 
                                                     & (~ (IData)(vlSelfRef.pe__DOT__u_mul__DOT__nan_a))) 
                                                    & (~ (IData)(vlSelfRef.pe__DOT__u_mul__DOT__nan_b))));
    vlSelfRef.pe__DOT__u_mul__DOT__s1_is_nan = ((IData)(vlSelfRef.rst_n) 
                                                && ((((IData)(vlSelfRef.pe__DOT__u_mul__DOT__nan_a) 
                                                      | (IData)(vlSelfRef.pe__DOT__u_mul__DOT__nan_b)) 
                                                     | ((IData)(vlSelfRef.pe__DOT__u_mul__DOT__zero_a) 
                                                        & (IData)(vlSelfRef.pe__DOT__u_mul__DOT__inf_b))) 
...
#endif
            VL_FATAL_MT("../rtl/pe.sv", 20, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("../rtl/pe.sv", 20, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("../rtl/pe.sv", 20, "", "Active region did not converge.");
            }
