...
- Testbench driver: C++ (standard for Verilator, not .sv)
- OS: Ubuntu 24.04 LTS
- Python 3.12.3 + NumPy 1.26: used for golden reference generation
...
**Testbench format:** Testbenches are written in C++ for use with
Verilator (industry-standard simulator). File extension is .cpp not .sv.
The Makefile in project/m2/tb/ drives all simulations.
