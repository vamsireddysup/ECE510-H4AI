...
#endif
            VL_FATAL_MT("../rtl/systolic_array.sv", 37, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vsystolic_array___024root___ctor_var_reset(Vsystolic_array___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->a_in[__Vi0] = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 13389479046651284173ull);
    }
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->b_in[__Vi0] = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 13248153975629471093ull);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->systolic_array__DOT__a_in[__Vi0] = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 6141809400136799329ull);
    }
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->systolic_array__DOT__b_in[__Vi0] = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 10849376740187762299ull);
    }
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 17; ++__Vi1) {
            vlSelf->systolic_array__DOT__a_wire[__Vi0][__Vi1] = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 9689322580825083726ull);
        }
    }
    for (int __Vi0 = 0; __Vi0 < 17; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 16; ++__Vi1) {
            vlSelf->systolic_array__DOT__b_wire[__Vi0][__Vi1] = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 17500985110034679907ull);
        }
    }
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 17; ++__Vi1) {
            vlSelf->systolic_array__DOT__v_wire_a[__Vi0][__Vi1] = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16970142679506756372ull);
        }
    }
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 16; ++__Vi1) {
            vlSelf->systolic_array__DOT__a_stagger[__Vi0][__Vi1] = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 9339873913801855476ull);
        }
    }
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 16; ++__Vi1) {
            vlSelf->systolic_array__DOT__b_stagger[__Vi0][__Vi1] = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 4298292703065892373ull);
        }
    }
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 16; ++__Vi1) {
