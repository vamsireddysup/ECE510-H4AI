...
#endif
            VL_FATAL_MT("../rtl/pe.sv", 37, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vpe___024root___stl_sequent__TOP__0(Vpe___024root* vlSelf) {
    ...
    vlSelfRef.pe__DOT__all_collected = (0x40U == vlSelfRef.pe__DOT__prod_count);
    ...
    vlSelfRef.pe__DOT____Vcellinp__u_add__b = vlSelfRef.pe__DOT__prod_buf
        [(0x3fU & vlSelfRef.pe__DOT__add_idx)];
...
VL_ATTR_COLD void Vpe___024root___ctor_var_reset(Vpe___024root* vlSelf) {
    ...
    vlSelf->pe__DOT__product = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 12231460546225769274ull);
    vlSelf->pe__DOT__product_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1351553120078187348ull);
    ...
    vlSelf->pe__DOT__u_mul__DOT__lut_result = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 11693335956401135437ull);
