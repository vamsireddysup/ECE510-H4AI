...
VL_INLINE_OPT void Vpe___024root___nba_sequent__TOP__0(Vpe___024root* vlSelf) {
    ...
    CData/*5:0*/ __VdlyDim0__pe__DOT__prod_buf__v0;
    ...
    if ((1U & (~ (IData)(vlSelfRef.rst_n)))) {
        vlSelfRef.pe__DOT__unnamedblk1__DOT__i = 0x40U;
    }
    if (vlSelfRef.rst_n) {
        if (((IData)(vlSelfRef.pe__DOT__product_valid) 
            ...
            __VdlyDim0__pe__DOT__prod_buf__v0 = (0x3fU 
        ...
        if ((0U == (IData)(vlSelfRef.pe__DOT__acc_state))) {
            if ((0x40U == vlSelfRef.pe__DOT__prod_count)) {
            ...
            if (vlSelfRef.pe__DOT__add_valid) {
                ...
                __Vdly__pe__DOT__waiting = 0U;
                if ((0x3fU == vlSelfRef.pe__DOT__add_idx)) {
    ...
    if (__VdlySet__pe__DOT__prod_buf__v1) {
        ...
        __Vilp1 = 0U;
        while ((__Vilp1 <= 0x3fU)) {
            vlSelfRef.pe__DOT__prod_buf[__Vilp1] = 0U;
