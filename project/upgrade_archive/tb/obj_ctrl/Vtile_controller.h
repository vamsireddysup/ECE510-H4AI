...
#ifndef VERILATED_VTILE_CONTROLLER_H_
#define VERILATED_VTILE_CONTROLLER_H_  // guard

#include "verilated.h"

class Vtile_controller__Syms;
class Vtile_controller___024root;
class VerilatedVcdC;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vtile_controller VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    Vtile_controller___024root* const rootp;
    ...
    explicit Vtile_controller(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vtile_controller(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vtile_controller();
  private:
    VL_UNCOPYABLE(Vtile_controller);  ///< Copying not allowed
