...
The active 4x4 engine uses exact quarter-unit integer dot products and two
...
| Sky130 mapped synthesis area, 4x4, `D_HEAD=64`, `T_MAX=16` | 303,141 um², complete top; no routed timing or power result |
...
The next design step is to load K once into a banked scratchpad, then overlap
